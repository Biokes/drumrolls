...
export default function Footer(){
    return (
        <div className={'pt-[50px] flex flex-col lg:flex-row gap-[30px]'}>
            ...
            <div className={'flex flex-col lg:flex-row gap-[15px] pl-[15px] md:pl-0'}>
                <input type="text" placeholder={'Full Name'} className={'w-[220px] h-[50px] p-[10px_15px] rounded-md border-1 outline-none'}/>
                <input type="email" placeholder={'Email'} className={'w-[220px] h-[50px] p-[10px_15px] rounded-md border-1 outline-none'}/>
                <input type="text" placeholder={'Phone Number'} className={'w-[220px] h-[50px] p-[10px_15px] rounded-md border-1 outline-none'}/>
                <input type="text"/>
